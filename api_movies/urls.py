...
urlpatterns = [
    ...
    url(r'^movies/(?P<pk>\d+)/$', views.MovieDetailAPIView.as_view(), name='movie_detail_api_view'),
    url(r'^raters/$', views.RaterListAPIView.as_view(), name='rater_list_api_view'),
    url(r'^raters/(?P<pk>\d+)/$', views.RaterDetailAPIView.as_view(), name='rater_detail_api_view')
]
